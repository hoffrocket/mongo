...
* 10278 [code](http://github.com/mongodb/mongo/blob/master/client/dbclient.cpp#L961) dbclient error communicating with server: 
...
* 14832 [code](http://github.com/mongodb/mongo/blob/master/db/dbcommands.cpp#L880) specify size:<n> when capped is true", !cmdObj["capped"].trueValue() || cmdObj["size"].isNumber() || cmdObj.hasField("$nExtents
...
* 8070 [code](http://github.com/mongodb/mongo/blob/master/s/chunk.cpp#L719) couldn't find a chunk which should be impossible: 
...
s/shard_version.cpp
----
* 10428 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L243) need_authoritative set but in authoritative mode already
* 10429 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L272) 
* 15904 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L107) cannot set version on invalid connection 
* 15905 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L112) cannot set version or shard on pair connection 
* 15906 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L115) cannot set version or shard on sync connection 
* 15918 [code](http://github.com/mongodb/mongo/blob/master/s/shard_version.cpp#L188) cannot initialize version on shard 


s/shardconnection.cpp
----
* 13409 [code](http://github.com/mongodb/mongo/blob/master/s/shardconnection.cpp#L253) can't parse ns from: 
...
----
* 10204 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L115) dbgrid: getmore: error calling db
* 10205 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L133) can't use unique indexes with sharding  ns:
* 13390 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L95) unrecognized command: 
* 8050 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L154) can't update system.indexes
* 8051 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L158) can't delete indexes on sharded collection yet
* 8052 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_single.cpp#L162) handleIndexWrite invalid write op
...
tools/dump.cpp
----
* 10262 [code](http://github.com/mongodb/mongo/blob/master/tools/dump.cpp#L119) couldn't open file
* 14035 [code](http://github.com/mongodb/mongo/blob/master/tools/dump.cpp#L73) couldn't write to file
...
* 9997 [code](http://github.com/mongodb/mongo/blob/master/tools/tool.cpp#L419) auth failed: 
...
----
* 10275 [code](http://github.com/mongodb/mongo/blob/master/util/net/message_server_port.cpp#L113) multiple PortMessageServer not supported
* 15887 [code](http://github.com/mongodb/mongo/blob/master/util/net/message_server_port.cpp#L141) 
...
* 15861 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L455) can't create SSL
* 15864 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L413) can't create SSL Context: 
* 15865 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L421) 
* 15866 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L427) 
* 15867 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L444) Can't read certificate file
* 15868 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L449) Can't read key file
